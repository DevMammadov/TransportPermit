...
import { BlankVM } from "@/ui/modules/SupplyChain/Blank/BlanksVM";
...
const PermitsPage = () => {
  ...
  if (!blankList?.items?.length && !isFiltered(filters)) {
  ...
  return (
    <div className="wrapper">
      ...
      <DataTable
        columns={columns}
        data={blankList?.items}
        count={blankList?.totalCount}
        title="İcazələrin Reyestri"
        currentPage={page}

...
import { InfoConfirmVM } from "@/ui/modules/SupplyChain/PointTransfer/newPointTransfer/steps/info-confirm/InfoConfirmVM";
...
const InfoConfirmPage = () => {
  const { declaration, prevStep, control, onSubmit, sendingLoading } =
    InfoConfirmVM();
  return (
    <StepLayout
    ...
    >
      <div className="border border-gray-200 rounded-2xl p-6 text-lg text-slate-800 font-semibold">
        <h3>Kod: {declaration?.permitCode}</h3>
        ...
        <div className="flex flex-col gap-3 text-base text-slate-800">
          ...
          <ListItem
            ...
            value={declaration?.receivingRegion}
          />
